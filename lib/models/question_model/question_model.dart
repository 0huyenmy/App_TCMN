...
class QuestionModel {
  ...
  final List<DataQuestionModel>? data;
  ...
  factory QuestionModel.fromJson(Map<String, dynamic> map) {
    return QuestionModel(
      ...
      data: map['data'] != null
          ? List<DataQuestionModel>.from(
              (map['data']).map<DataQuestionModel?>(
                (x) => DataQuestionModel.fromJson(x as Map<String, dynamic>),
              ),
            )
          : null,
  ...
  @override
  String toString() {
    return 'QuestionModel(current_page: $current_page, data: $data, first_page_url: $first_page_url, from: $from, last_page: $last_page, last_page_url: $last_page_url, path: $path, per_page: $per_page, to: $to, total: $total)';
  }
